...
from models.UNet3P import UNet3P, DeepSup_UNet3P, DeepSup_ResUNet3P
...
def evaluate_model_baseline(model, device, image_root, result_root,label_root, width=128, height=128):
